...
\newcommand{\bdefinicion}{\begin{framed} \begin{definicion}}
\newcommand{\edefinicion}{\end{definicion} \end{framed}}

\newcommand{\blema}{\begin{framed} \begin{lema}}
\newcommand{\elema}{\end{lema} \end{framed}}

\def\bteoremaa{\begin{framed} \begin{teorema}}
\def\eteorema{\end{teorema} \end{framed}}
\def\bteorema#1{\begin{framed} \begin{teorema}[\textbf{#1}]}

\newcommand{\bcorolario}{\begin{framed} \begin{corolario}}
\newcommand{\ecorolario}{\end{corolario} \end{framed}}

\newcommand{\bproposicion}{\begin{framed} \begin{proposicion}}
\newcommand{\eproposicion}{\end{proposicion} \end{framed}}

\theoremstyle{definition}
\newtheorem{algoritmo}{Algoritmo}[chapter]

\newcommand{\balgoritmo}{\begin{framed} \begin{algoritmo}}
\newcommand{\ealgoritmo}{\end{algoritmo} \end{framed}}
